...
function initMap() {
	var myLatlng = new google.maps.LatLng(-26.11173,27.94567); // <- Your latitude and longitude
	var styles = [
	{
		"featureType": "water",
		"stylers": [{
	...
	var latlng = {lat: -26.11173, lng: 27.94567};
  ...
  document.getElementById("address").innerHTML = "<strong>Address . . . . .</strong> " + results[0].formatted_address;
      } else {
